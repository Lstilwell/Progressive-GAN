...
#train = EasyDict(func='util_scripts.evaluate_metrics', run_id="/home/data/results_256/000-pgan-celeba-fp16-mb64-lod4-600-1gpu/", log="metric-swd.log", metrics=['swd'], num_images=16384, real_passes=2); num_gpus = 1; desc = train.log.split('.')[0] + '-' + str(train.run_id)
