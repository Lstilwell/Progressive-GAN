...
#train = EasyDict(func='util_scripts.evaluate_metrics', run_id="/home/data/results_128/repelling_regularizer_resnetDG/012-pgan-celebahq-preset-v2-1gpu-fp32/", log="metric-swd.log", metrics=['swd','fid','is','msssim'], num_images=16384, real_passes=2); num_gpus = 1; desc = train.log.split('.')[0] + '-' + str(train.run_id)
